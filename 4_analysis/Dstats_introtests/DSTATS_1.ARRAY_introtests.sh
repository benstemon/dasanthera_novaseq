...
#SBATCH --output=slurm-Dsuite_introtests_%a.out
#SBATCH --error=slurm-Dsuite_introtests_%a.error
...
cd $dstat_outdir
Dsuite Dinvestigate -n $run_name -w 10000,2500 $invcf $popset $trioset
