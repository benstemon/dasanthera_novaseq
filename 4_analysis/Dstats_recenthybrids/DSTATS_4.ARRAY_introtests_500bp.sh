...
#SBATCH --output=slurm-Dsuite_introtests_500bp_%a.out
#SBATCH --error=slurm-Dsuite_introtests_500bp_%a.error
...
cd $dstat_outdir
Dsuite Dinvestigate -n 500bp_$run_name -w 500,125 $invcf $popset $trioset
